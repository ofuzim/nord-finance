...
const tiers = [
  ...
  { label: "Core", range: "700–799", rate: "22%+ p.a.", color: "#38bdf8" },
  { label: "Premium", range: "800–849", rate: "18%+ avg.", color: "#a855f7" },
  { label: "Private Bridge", range: "850+", rate: "9%+ from", color: "#9ca3af" },
];
