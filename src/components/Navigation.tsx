    ...
    <>
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 70, flex: 1, minWidth: 0 }}>
          <Link
            href="/"
            prefetch={false}
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, alignItems: "center", marginTop: 4 }}>
          ...
          <div style={{ display: "flex", gap: 28, alignItems: "center", justifyContent: "center", marginTop: 28 }}>
            {[
              {
                href: "https://wa.me/2348149799150", label: "WhatsApp",
                icon: (
                  <svg width="27" height="27" viewBox="0 0 32 32" fill="currentColor" aria-hidden>
